  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="lg:basis-1/2 text-lg lg:text-2xl">
        <p className="leading-10 text-justify mb-5">
        ...
        <p className="leading-10">I enjoy learning new stuff to help me progress as a software developer and I would love to work for a company that will help me achieve this.</p>
      </div>
    </div>
  )
}
